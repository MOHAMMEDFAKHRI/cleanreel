...
export default function Home({ uploading, onFile }) {
  ...
  return (
    <>
      ...
      <button
        ...
        onClick={() => !uploading && pick(null)}
        onDragOver={(e) => { e.preventDefault(); setDrag(true) }}
        onDragLeave={() => setDrag(false)}
        onDrop={(e) => { e.preventDefault(); setDrag(false); if (!uploading) onFile(e.dataTransfer.files?.[0], null) }}
        disabled={!!uploading}
      >
        {uploading ? (
          <>
